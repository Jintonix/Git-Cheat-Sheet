...
\fancyfoot[RO,RE]{ \hspace{1mm} J. A. Schneider}

\fancypagestyle{plain}{
    \fancyhf{} % clear all footer & header fields
    \renewcommand{\headrulewidth}{0pt}
    \fancyfoot[CE,CO]{\textbf{\textendash} \textbf{\thepage} \textbf{\textendash}}
    \fancyfoot[RO,RE]{J. A. Schneider}
}

% --- Chapter format ---
\titleformat{\chapter}[block] 
  {\normalfont\color{orange}\fontsize{60}{60}\selectfont\bfseries} % title font
  {}               % chapter number
...
\titlespacing*{\chapter}{3cm}{1.5cm}{-1cm}

% --- Hook to place TikZ overlay on chapter page ---
...
\include{Chapters/Ch3 - Branching}
\include{Chapters/Ch4 - Merging}
\include{Chapters/Ch4.1 - Solving Conflicts}
\include{Chapters/Ch5 - Rebasing}
\include{Chapters/Ch6 - Solving Conflicts}
\include{Chapters/Ch7 - Fetch & Pull}
\include{Chapters/Ch8 - Tracking Path Changes}
